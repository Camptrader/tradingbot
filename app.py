                ...
                if saved_params_record and "params" in saved_params_record:
                    ...
                    def json_to_tv_preset(json_path):
                        ...
                        param_map = {
                            ...
                            "trailpct": "_TrailPct",
                            "session_start": ("_startHour", "_startMinute"),
                            "session_end": ("_endHour", "_endMinute"),
                        }
...
if run_saved_params:
    ...
    # Make sure you have access to df, strategy_func, universal_keys, etc.
    ...
    call_kwargs.update(best_params)  # Use stored params
    trades, df_all = strategy_func(df, **call_kwargs)
    # Display results as you already do...
